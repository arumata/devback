...
func (m *mockGitInit) GetCommitHash(ctx context.Context, repoPath string) (string, error) {
	return "", nil
}

func (m *mockGitInit) ObjectExists(ctx context.Context, repoPath, hash string) (bool, error) {
	return true, nil
}
